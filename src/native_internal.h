...
int krait_agent_change_count(void);
int krait_agent_checkpoint_count(void);
int krait_agent_checkpoint_selected(void);
const char *krait_agent_checkpoint_name(void);
int krait_agent_checkpoint_select(int index);
const char *krait_agent_change_path(int index);
const char *krait_agent_change_content(int index, int after);
int krait_agent_change_review(int index);
int krait_agent_review_change(int index, int accept);
